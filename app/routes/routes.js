...
router.put('/lendBook', userController.allowIfLoggedin, userController.grantAccess('updateAny', 'lend'), userController.updateUserLend);
...
router.get('/book', userController.allowIfLoggedin, userController.grantAccess('readAny', 'book'), bookController.getBook);
...
router.put('/book', userController.allowIfLoggedin, userController.grantAccess('updateAny', 'book'), bookController.updateBook);
...
router.delete('/book', userController.allowIfLoggedin, userController.grantAccess('deleteAny', 'book'), bookController.deleteBook);
